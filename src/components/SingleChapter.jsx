...
class SingleChapter extends Component {
  constructor() {
    ...
    this.handleSectionVideoMemRequired = this.handleSectionVideoMemRequired.bind(
      this
    );
  ...
  openSectionEditModal(i) {
    axios
      .get("/api/section/" + i + "/" + this.props.match.params.chapter)
      .then(section => {
        this.setState({
  ...
  addSectionVideo() {
    let body = {
      ...
      video_id: this.state.sectionVideo.video_id
        ? this.state.sectionVideo.video_id
        : null,
      ...
      this.state.videos.length > 0
        ? this.state.videos.map((e, i) => {
            return (
              <div>
                <h1>{e.video_title}</h1>
                <button onClick={() => this.vimeoEditModal(e.video_id)}>
                  Edit
                </button>
                <button onClick={() => this.vimeoDeleteModal(e.video_id)}>
                  Delete
                </button>
        ...
        ? this.state.sections.map((e, i) => {
                  ...
                  <div className="videotile">
                    ...
                    {!this.props.user.is_admin ? null : (
                      <button
                        ...
                        onClick={() => this.videoEditModal(x.sectionVideoId)}
                      >
                        Edit Video
                      </button>
                    )}
                    {!this.props.user.is_admin ? null : (
                      <button
                        className="adminbutton"
                        onClick={() => this.videoDeleteModal(x.sectionVideoId)}
                      >
                        Delete Video
                      </button>
                    )}
            ...
            return (
              <a
                name={e.sectionTitle}
                key={e.sectionTitle}
                className="sectionbodycontainer"
              >
                ...
                <div className="adminbuttoncontainer">
                  {!this.props.user.is_admin ? null : (
                    <button
                      className="adminbutton"
                      onClick={() => this.openVideoAddModal(e.sectionNumber)}
                    >
                      Add Video
                    </button>
                  )}
                  {!this.props.user.is_admin ? null : (
                    <button
                      className="adminbutton"
                      onClick={() => this.openSectionEditModal(e.sectionNumber)}
                    >
                      Edit Section
                    </button>
                  )}
                  {!this.props.user.is_admin ? null : (
                    <button
                      className="adminbutton"
                      onClick={() =>
                        this.openSectionDeleteModal(e.sectionNumber)
                      }
                    >
                      Delete Section
                    </button>
                ...
                <div className="bodyvideocontainer">{bodyVideoMap}</div>
              </a>
            );
          })
        : null;
      ...
      <div className="singlechapterbody">
        ...
        <div className="singlechaptercontent">
          ...
          <Modal
            ...
            onRequestClose={this.closeAddSectionModal}
            style={addStyles}
          >
            ...
            <div className="checkboxfield">
              ...
              <input
                ...
                onChange={e => this.handleSectionTitle(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
              ...
              <input
                ...
                onChange={e => this.handleSectionNumber(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
              ...
              <input
                ...
                onChange={e => this.handleSectionText(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
              ...
              <input
                value={this.state.memRequiredSection}
                onChange={e => this.handleSectionMemRequired(e.target.checked)}
                type="checkbox"
              />
            </div>
            <div className="checkboxfield">
              ...
              <input
                ...
                value={this.state.memIdsSection}
                onChange={e => this.handleSectionMemIds(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
              ...
              <input
                ...
                value={this.state.practiceProblemsIds}
                onChange={e => this.handlePracticeProblemIds(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
              Upload Section Handout:{" "}
              <button className="upload-button" onClick={this.handleSectionPDF}>
                Add PDF
              </button>
            </div>
          ...
          <Modal
            isOpen={this.state.sectionEditModal}
            onRequestClose={this.closeSectionEditModal}
            style={addStyles}
          >
          ...
          <Modal
            isOpen={this.state.sectionDeleteModal}
            onRequestClose={this.closeSectionDeleteModal}
            style={addStyles}
          >
          ...
          <Modal
            isOpen={this.state.videoAddModal}
            onRequestClose={this.closeVideoAddModal}
            style={addStyles}
          >
            ...
            <div className="checkboxfield">
              ...
              <input
                ...
                value={this.state.sectionVideoTitle}
                onChange={e => this.handleSectionVideoTitle(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
              ...
              <input
                ...
                value={this.state.sectionVideoText}
                onChange={e => this.handleSectionVideoText(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
            ...
            <p>
              Current Video:{" "}
              {this.state.sectionVideo.video_title
                ? this.state.sectionVideo.video_title
                : null}
            </p>
            <div className="checkboxfield">
              Is Membership Required?{" "}
              <input
                value={this.state.memRequiredVideo}
                onChange={e =>
                  this.handleSectionVideoMemRequired(e.target.checked)
                }
                type="checkbox"
              />
            </div>
            <div className="checkboxfield">
              Membership IDs:{" "}
              <input
                placeholder="Video Membership IDs"
                value={this.state.memIdsVideo}
                onChange={e => this.handleSectionVideoMemIds(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
              Upload Video Handout:{" "}
              <button
                className="upload-button"
                onClick={this.handleSectionVideoPDF}
              >
                Add PDF
              </button>
            </div>
          ...
          <Modal
            isOpen={this.state.videoEditModal}
            onRequestClose={this.closeVideoEditModal}
            style={addStyles}
          >
            ...
            <div className="checkboxfield">
              ...
              <button onClick={this.openVideosModal}>Choose</button>
            </div>
            <p>
              Current Video:{" "}
              {this.state.sectionVideo.video_title
          ...
          <Modal
            isOpen={this.state.videoDeleteModal}
            onRequestClose={this.closeVideoDeleteModal}
            style={addStyles}
          >
          ...
          <Modal
            isOpen={this.state.videosModal}
            onRequestClose={this.closeVideosModal}
            style={addStyles}
          >
          ...
          <Modal
            isOpen={this.state.vimeoModal}
            onRequestClose={this.closeVimeoModal}
            style={addStyles}
          >
            ...
            <div className="checkboxfield">
              ...
              <input
                ...
                value={this.state.vimeoVideoTitle}
                onChange={e => this.handleVimeoVideoTitle(e.target.value)}
                type="text"
              />
            </div>
            <div className="checkboxfield">
              ...
              <input
                ...
                value={this.state.vimeoVideoUrl}
                onChange={e => this.handleVimeoVideoUrl(e.target.value)}
                type="text"
              />
            </div>
          ...
          <Modal
            isOpen={this.state.vimeoEditModal}
            onRequestClose={this.closeVimeoEditModal}
            style={addStyles}
          >
          ...
          <Modal
            isOpen={this.state.vimeoDeleteModal}
            onRequestClose={this.closeVimeoDeleteModal}
            style={addStyles}
          >
